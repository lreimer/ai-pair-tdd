...
Search the current repo (using #githubRepo for the repo info) and list any open issues you find (using #github/list_issues) that are assigned to me (using #github/get_me).
